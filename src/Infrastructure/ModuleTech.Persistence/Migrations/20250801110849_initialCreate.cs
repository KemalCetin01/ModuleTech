        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerificationType = table.Column<int>(type: "integer", nullable: true, defaultValue: 1, comment: "1:email - 2:phone"),
                    ...
                    OtpType = table.Column<int>(type: "integer", nullable: true, defaultValue: 1, comment: "1:signUp - 2:ResetPassword - 3:CreatePassword"),
                    Platform = table.Column<int>(type: "integer", nullable: true, defaultValue: 1, comment: "1:b2b - 3:employee")
                },
                constraints: table =>
                {
