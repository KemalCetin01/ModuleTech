...
public class BusinessUserTableFilter
{
    public static IQueryable<BusinessUser> Filter(IQueryable<BusinessUser> query, BusinessUserQueryServiceFilter userQueryFilter)
    {
