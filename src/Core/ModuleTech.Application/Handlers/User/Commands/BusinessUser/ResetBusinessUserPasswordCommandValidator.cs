...
public class ResetBusinessUserPasswordCommandValidator : AbstractValidator<ResetBusinessUserPasswordCommand>
{
    public ResetBusinessUserPasswordCommandValidator()
    {
