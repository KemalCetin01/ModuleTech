...
builder.Services.AddAuthentication("Bearer")
    .AddJwtBearer("Bearer", options =>
    {
        ...
        options.RequireHttpsMetadata = false; // Geli�tirme ortam�nda HTTPS zorunlulu�unu kald�r�r
        options.Audience = "ms:ModuleTech"; // Client ID
    });

builder.Services.AddAuthorization(); // Bu sat�r zaten vard�
...
builder.Services.AddApiLayer(); //RequestBus ve MediatR i�in gerekli servisleri ekler
builder.Services.AddServices(); //ITransientService ve IScopedService i�in gerekli servisleri ekler. interfaceye IScoped ekliyse otomatik olarak Scoped olarak ekler. ITransientService ise Transient olarak ekler.
